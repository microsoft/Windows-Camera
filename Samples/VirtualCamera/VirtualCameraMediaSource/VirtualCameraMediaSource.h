...
enum
{
    KSPROPERTY_AUGMENTEDMEDIASOURCE_CUSTOMCONTROL_SETBACKGROUNDBLUR = 0,
    KSPROPERTY_AUGMENTEDMEDIASOURCE_CUSTOMCONTROL_CUSTOMFX = 1 + KSPROPERTY_AUGMENTEDMEDIASOURCE_CUSTOMCONTROL_SETBACKGROUNDBLUR,
    KSPROPERTY_AUGMENTEDMEDIASOURCE_CUSTOMCONTROL_END  // all ids must be defined before this.
};

#define KSPROPERTY_AUGMENTEDMEDIASOURCE_CUSTOMCONTROL_SETBACKGROUNDBLUR_OFF  0x000000000
#define KSPROPERTY_AUGMENTEDMEDIASOURCE_CUSTOMCONTROL_SETBACKGROUNDBLUR_BLUR 0x000000001
...
typedef struct
{
    ULONG ControlId;
    ULONG ControlFlag;
} KSPROPERTY_AUGMENTEDMEDIASOURCE_CUSTOMCONTROL_S, * PKSPROPERTY_AUGMENTEDMEDIASOURCE_CUSTOMCONTROL_S;
