...
namespace winrt::VirtualCameraManager_WinRT::implementation
{
    struct CameraKsPropertyInquiry : CameraKsPropertyInquiryT<CameraKsPropertyInquiry>
    {
        ...
        static void SetSimpleCustomControlFlags(winrt::VirtualCameraManager_WinRT::SimpleCustomControlKind const& customControlKind, winrt::Windows::Media::Devices::VideoDeviceController const& controller, uint64_t flags);
